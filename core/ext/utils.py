...
class emj:
    ...
    insta = u.get(bot.emojis, name="insta")
    twitter = u.get(bot.emojis, name="twitter")
    bungie = u.get(bot.emojis, name="bungie")
    steam = u.get(bot.emojis, name="steam")
    github = u.get(bot.emojis, name="github")
    utube = u.get(bot.emojis, name="youtube")
    """